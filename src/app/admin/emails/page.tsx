...
import {
  ...
  LogOut, Menu, Shield, Search, MoreHorizontal, CheckCircle, XCircle,
} from "lucide-react";
import {
...
const sidebarItems = [
  ...
  { icon: Mail, label: "Emails", href: "/admin/emails", active: true },
    ...
    <div className="min-h-screen bg-slate-900 flex">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        <header className="bg-slate-800 border-b border-slate-700 px-6 py-4">
          ...
          <div>
            <h1 className="text-xl font-semibold text-white">Gestão de Emails</h1>
            <p className="text-sm text-slate-400">Gerencie todas as contas de email</p>
          </div>
        </header>
        ...
        <main className="flex-1 p-6">
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              <CardTitle className="text-white">Contas de Email</CardTitle>
              <CardDescription className="text-slate-400">Todas as contas criadas no sistema</CardDescription>
            </CardHeader>
            <CardContent className="text-center py-12">
              <Mail className="h-12 w-12 text-slate-600 mx-auto mb-4" />
              <p className="text-slate-400">Nenhuma conta de email cadastrada</p>
              <p className="text-sm text-slate-500 mt-2">As contas aparecerão aqui quando os clientes criarem</p>
            </CardContent>
          </Card>
        </main>
      </div>
