...
import {
  ...
  LogOut, Menu, Shield, BarChart3, TrendingUp, TrendingDown, DollarSign,
...
const sidebarItems = [
  ...
  { icon: BarChart3, label: "Relatórios", href: "/admin/reports", active: true },
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        <header className="bg-slate-800 border-b border-slate-700 px-6 py-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">Análises e estatísticas do sistema</p>
          </div>
        </header>
        ...
        <main className="flex-1 p-6">
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">Análises e métricas do negócio</CardDescription>
            </CardHeader>
            <CardContent className="text-center py-12">
              <BarChart3 className="h-12 w-12 text-slate-600 mx-auto mb-4" />
              <p className="text-slate-400">Relatórios em desenvolvimento</p>
              <p className="text-sm text-slate-500 mt-2">Em breve você terá acesso a gráficos e análises detalhadas</p>
            </CardContent>
          </Card>
        </main>
      </div>
